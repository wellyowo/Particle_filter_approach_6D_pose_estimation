...
if opt.dataset == "ycb":
    ...
    mean_add_s = []
    with open(opt.save_path + "ADDs_result.txt", mode='wt+') as file:
        for model in models:
            print("*** ", model)
        ...
        print("average time : ", time_sum / len(lines),file=file)
